                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-3">
                                                ...
                                                <ul class="link-list">
                                                    <li><a href="/visa-detail">Student Visa Assessment</a></li>
                                                    <li><a href="/visa-detail">Working Visa Assessment</a></li>
                                                    <li><a href="/visa-detail">Business Visa Assessment</a></li>
                                                    <li><a href="/visa-detail">PR Visa Assessment</a></li>
                                                    <li><a href="/visa-detail">Visa Eligibility Assessment</a></li>
                                                    <li><a href="/visa-detail">Family Visa Assessment</a></li>
                                                    <li><a href="/visa-detail">Immigration Consultation</a></li>
                                                </ul>
                                            ...
                                            <div class="col-md-12 col-lg-5">
                                                ...
                                                <!-- Text -->
                                                <h5 class="h5-md"><a href="/articles/{{$articles[0]->slug ?? ''}}">{{$articles[0]->title ?? ''}}We make the visa process faster</a></h5>
                                                <p class="wsmwnutxt">{{$articles[0]->excerpt ?? ''}}Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
                                                ...
                                                <ul class="latest-news">
                                                    ...
                                                    <li class="clearfix d-flex align-items-center">
                                                        ...
                                                        <div class="post-summary">
                                                            <a href="/articles/{{$articles[1]->slug ?? ''}}">{{$articles[1]->title ?? ''}}Etiam sapien risus ante auctor tempus accumsan an empor ...</a>
                                                            <p>43 Comments</p>
                                                        </div>
                                                    ...
                                                    <li class="clearfix d-flex align-items-center">
                                                        ...
                                                        <!-- Text -->
                                                        <div class="post-summary">
                                                            <a href="/articles/{{$articles[2]->slug ?? '' }}">{{$articles[2]->title ?? ''}}Blandit tempor a sapien ipsum, porta risus auctor justo ...</a>
                                                            <p>38 Comments</p>
                                                        </div>
                                                    ...
                                                    <li class="clearfix d-flex align-items-center">
                                                        ...
                                                        <!-- Text -->
                                                        <div class="post-summary">
                                                            <a href="/articles/{{$articles[3]->slug ?? ''}}">{{$articles[3]->title ?? ''}}Cursus risus an auctor risus laoreet turpis auctor varius ...</a>
                                                            <p>29 Comments</p>
                                                        </div>
...
<newsletter-form></newsletter-form>
            ...
            <div class="bottom-footer">
                <div class="row d-flex align-items-center">
                    ...
                    <!-- FOOTER COPYRIGHT -->
                    <div class="col-lg-6">
                        <p class="footer-copyright">&copy; Copyright <span>MigrationMasters 2019</span>. All Rights Reserved</p>
                    </div>
