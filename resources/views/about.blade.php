                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="hero-txt white-color">
                            <h2 class="h2-xs">About VisaPRO</h2>
                        </div>
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb white-color">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">About VisaPRO</li>
                            </ol>
                        </nav>
                    </div>
                </div>  <!-- End row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="about-5-txt mb-40">
                                    ...
                                    <ul class="abox-list">
                                        ...
                                        <li class="more-info-link deepblue-color"><a href="#">View All</a></li>
                                    </ul>
                            ...
                            <div class="col-sm-6">
                                <div class="about-5-txt mb-40">
                                    ...
                                    <!-- Title -->
                                    <h5 class="h5-xl">Pratice Area:</h5>
                        ...
                        <div class="owl-carousel owl-theme reviews-holder">
                            ...
                            <div class="review-1">
                                ...
                                <div class="author-data clearfix">
                                    ...
                                    <!-- Author Data -->
                                    <div class="review-author">
                                        <h5 class="h5-xs">Amelie Peterson</h5>
